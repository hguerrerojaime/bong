...
@Component({
    ...
    <aside id="sidebar_right" class="nano affix has-scrollbar">
       ...
       <div class="sidebar-right-content nano-content" tabindex="0" style="margin-right: -17px;">
     ...
     <div class="nano-pane" style="display: block;"><div class="nano-slider" style="height: 265px; transform: translate(0px, 0px);"></div></div></aside>

    `
})
export default class SidebarRightComponent {
